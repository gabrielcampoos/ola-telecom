						...
						>
							...
							>
								<Typography textAlign="initial">
									Confira as novidades quentinhas,
						...
						>
							...
							>
								<Box
									...
									mb={3}
									onClick={() =>
										navigate('/ola-telecom-senha-segura')
									}
									sx={{
								...
								>
									...
									>
										<Typography
											...
											textTransform="uppercase"
										>
											Cinco passos para uma senha mais
											segura
										</Typography>
									</Box>
								</Box>
							...
							>
								<Box
									...
									mb={3}
									onClick={() =>
										navigate('/ola-telecom-mito-fibra')
									}
									sx={{
										background: 'transparent',
										border: 'none',
								...
								>
									...
									>
										<Typography
											...
											textAlign="center"
										>
											Os melhores jogos de pc em 2023 até
											agora
										</Typography>
										...
										>
											<Typography
												...
												textTransform="uppercase"
											>
												Os melhores jogos de pc em 2023
												até agora
											</Typography>
										</Box>
									</Box>
